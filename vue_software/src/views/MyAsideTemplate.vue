...
<!--      <router-link :to="{ path:'home/' + navMenu0.entity.id }">-->
      <router-link :to="{ path:navMenu0.entity.id }">
        <el-menu-item v-if="navMenu0.childs==null&&navMenu0.entity&&navMenu0.entity.state==='ENABLE'"
      ...
      <el-submenu v-if="navMenu0.childs&&navMenu0.entity&&navMenu0.entity.state==='ENABLE'"
